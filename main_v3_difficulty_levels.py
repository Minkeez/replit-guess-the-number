...
def choose_difficulty():
  while True:
    difficulty = input("Choose a difficulty. Type 'very easy', 'easy', 'medium', 'hard', 'very hard', 'extreme', or 'custom': ").lower()
    if difficulty == "very easy":
      return {"attempts": 15, "min_val": 1, "max_val": 50}
    elif difficulty == "easy":
      return {"attempts": 10, "min_val": 1, "max_val": 100}
    elif difficulty == "medium":
      return {"attempts": 7, "min_val": 1, "max_val": 150}
    elif difficulty == "hard":
      return {"attempts": 5, "min_val": 1, "max_val": 200}
    elif difficulty == "very hard":
      return {"attempts": 3, "min_val": 1, "max_val": 300}
    elif difficulty == "extreme":
      return {"attempts": 2, "min_val": 1, "max_val": 500}
      ...
      print("Invalid input. Please type 'very easy', 'easy', 'medium', 'hard', 'very hard', 'extreme', or 'custom' only.")
